  ...
  const teamMembers = [
    {
      ...
      bio: "With over 20 years of experience in travel industry, Rajesh founded Indic Journeys with a vision to showcase authentic Indian experiences to travelers.",
    },
    {
      name: "Priya Patel",
      role: "Travel Experience Director",
      image: "/placeholder.svg?height=200&width=200",
      bio: "Priya has designed hundreds of unique itineraries and specializes in creating transformative travel experiences.",
    },
    {
      name: "Amit Kumar",
      role: "Operations Manager",
      image: "/placeholder.svg?height=200&width=200",
      bio: "Amit ensures that every journey runs smoothly, from logistics to accommodations, with exceptional attention to detail.",
    },
    {
      name: "Sarah Johnson",
      role: "International Relations",
      image: "/placeholder.svg?height=200&width=200",
      bio: "Sarah manages our international partnerships and ensures our global travelers receive culturally sensitive guidance.",
    },
  ]
  ...
  return (
    <MainLayout>
      ...
      <section className="py-16 lg:py-24 bg-white">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <span className="text-yellow-400 font-semibold font-open-sans">OUR TEAM</span>
            <h2 className="text-3xl lg:text-4xl font-bold font-poppins mb-6">Meet The Experts</h2>
            <p className="max-w-3xl mx-auto text-gray-700 font-open-sans">
              Our passionate team of travel specialists is dedicated to creating unforgettable experiences for every
              traveler.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {teamMembers.map((member, index) => (
              <div key={index} className="text-center group">
                ...
                <p className="text-gray-600 font-open-sans">{member.bio}</p>
              </div>
            ))}
          </div>
        </div>
